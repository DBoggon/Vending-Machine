...
Java console program which allows user to add funds, keeps track of amount added and dispense food objects based on user input/funds balance.

### Features

1. The vending machine dispenses beverages, candy, chips, and gum.
   - Each vending machine item has a Name and a Price.
2. Main menu must displays when the software runs, presenting the following options:
    > ```
